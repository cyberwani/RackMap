<?php
//============================================================+
// File name   : tce_script_generator.php
// Begin       : 2011-10-31
...
$pagelevel = K_AUTH_SCRIPT_GENERATOR;
require_once('../../shared/code/tce_authorization.php');

$thispage_title = $l['t_script_generator'];
...
switch($menu_mode) { // process submitted data
	...
	case 'generate': { // generate script
		$script = '';
		// add header template
		$script .= F_get_template($header_tmp_id);
		// get template
...
$sql = 'SELECT * FROM '.K_TABLE_TEMPLATES.' WHERE tmp_name NOT LIKE \'SSH%\' ORDER BY tmp_name ASC';
